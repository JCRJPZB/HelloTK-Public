    ...
    execute: function () {
      ...
      _export("BattleFieldMaker", BattleFieldMaker = (_dec = ccclass('BattleFieldMaker'), _dec(_class = (_temp = class BattleFieldMaker extends Component {
        ...
        prepare(enemy_conf) {
          ...
          let ally_node = army_node === null || army_node === void 0 ? void 0 : army_node.getChildByName("Allies"); // 友方队伍父节点

          let enemy_node = army_node === null || army_node === void 0 ? void 0 : army_node.getChildByName("Enemies"); // 敌方队伍父节点
