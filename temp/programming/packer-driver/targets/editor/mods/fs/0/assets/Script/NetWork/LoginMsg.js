    ...
    execute: function () {
      ...
      _export("LoginMsg", LoginMsg = (_dec = ccclass('LoginMsg'), _dec(_class = class LoginMsg extends Component {
        ...
        login(userId, pw, datetime, platform, others) {
          ...
          let pwCode = (_crd && MD5 === void 0 ? (_reportPossibleCrUseOfMD({
            error: Error()
          }), MD5) : MD5).md5(pw);
        ...
        parseMsg(userId, datetime, platform, token, others) {
          let key = (_crd && Configure === void 0 ? (_reportPossibleCrUseOfConfigure({
            error: Error()
          ...
          let verifyCode = (_crd && MD5 === void 0 ? (_reportPossibleCrUseOfMD({
            error: Error()
