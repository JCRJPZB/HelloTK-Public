    ...
    execute: function () {
      ...
      _export("Inventory", Inventory = (_dec = ccclass('Inventory'), _dec(_class = (_temp = class Inventory extends (_crd && UIBase === void 0 ? (_reportPossibleCrUseOfUIBase({
        ...
        setCategroy() {
          ...
          var itemTypes = this.itemMgr.getItemTypes();
          itemTypes.forEach(type => {
            ...
            if (this.category_root) {
              ...
              var category_node = this.gen.generator(this.category_root, "Inventory_Category");
              category_node === null || category_node === void 0 ? void 0 : category_node.on("click", () => {
                this.refreshItems(type["type_id"]);
              });
              var category_name_lbl = category_node === null || category_node === void 0 ? void 0 : (_category_node$getChi = category_node.getChildByName("Name")) === null || _category_node$getChi === void 0 ? void 0 : _category_node$getChi.getComponent(Label);
        ...
        refreshItems(type) {
          ...
          var items = (_this$inventoryMgr = this.inventoryMgr) === null || _this$inventoryMgr === void 0 ? void 0 : _this$inventoryMgr.getInventoryByType(type);
