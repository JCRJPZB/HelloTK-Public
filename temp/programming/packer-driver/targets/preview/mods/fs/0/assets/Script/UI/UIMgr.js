    ...
    execute: function () {
      ...
      _export("UIMgr", UIMgr = (_dec = ccclass('UIMgr'), _dec(_class = (_temp = _class2 = class UIMgr extends Component {
        ...
        _reset(scene_name, num, data) {
          ...
          var rootPath = this._UIConf["root"];
          var typeArr = this._UIConf["types"];
          ...
          typeArr.forEach(type => {
            ...
            var node = (_this$_root_UI = this._root_UI) === null || _this$_root_UI === void 0 ? void 0 : _this$_root_UI.getChildByName(type["node_name"]);
        ...
        openUI(strName, layer, params) {
          var ui = this._UIMap.get(strName);
          ...
          if (!ui) {
            var layer_node = this._mapLayer.get(layer);
            ...
            var ui_node = (_crd && Generator === void 0 ? (_reportPossibleCrUseOfGenerator({
              error: Error()
        ...
        goBackPage() {
          var length = this._stackPageName.length;
          ...
          var prePage = this._stackPageName.pop();
