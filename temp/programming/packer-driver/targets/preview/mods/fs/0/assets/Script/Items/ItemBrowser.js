      ...
      _export("ItemBrowser", ItemBrowser = (_dec = ccclass('ItemBrowser'), _dec(_class = (_temp = class ItemBrowser extends Component {
        ...
        init(data) {
          ...
          if (this.data["access"]) {
            ...
            this.data["access"].forEach(access => {
              ...
              var new_access = this.gen.generator(this.access_root, "Item_Access");
              var access_name_lbl = new_access === null || new_access === void 0 ? void 0 : (_new_access$getChildB = new_access.getChildByName("Name")) === null || _new_access$getChildB === void 0 ? void 0 : _new_access$getChildB.getComponent(Label);
        ...
        refreshUseNum() {
          ...
          if (this.use_item_add_btn && this.use_item_add_disable_btn) {
            var flag = this.use_item_num < this.item_num && this.use_item_num < this.data["max_num_once"];
