    ...
    execute: function () {
      ...
      _export("LeagueList", LeagueList = (_dec = ccclass('LeagueList'), _dec(_class = (_temp = class LeagueList extends (_crd && UIBase === void 0 ? (_reportPossibleCrUseOfUIBase({
        ...
        refreshList() {
          ...
          var league_list = this.leagueMgr.getLeagueList();
          ...
          var display_list = (_crd && Functions === void 0 ? (_reportPossibleCrUseOfFunctions({
            error: Error()
          ...
          display_list.forEach(league => {
            ...
            var league_node = this.gen.generator(this.list_root, "League_Join");
            var ctrl = league_node === null || league_node === void 0 ? void 0 : league_node.getComponent(_crd && LeagueJoin === void 0 ? (_reportPossibleCrUseOfLeagueJoin({
              error: Error()
