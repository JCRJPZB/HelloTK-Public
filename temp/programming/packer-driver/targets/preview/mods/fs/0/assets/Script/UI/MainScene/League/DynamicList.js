    ...
    execute: function () {
      ...
      _export("DynamicList", DynamicList = (_dec = ccclass('DynamicList'), _dec(_class = (_temp = class DynamicList extends (_crd && UIBase === void 0 ? (_reportPossibleCrUseOfUIBase({
        ...
        onInit(league_id) {
          ...
          if (this.page_num_box) {
            ...
            this.page_num_box.node.on("editing-did-ended", box => {
              var page_num = Number(box.string);
        ...
        refreshDynamics(league_id) {
          ...
          var dynamics = this.leagueMgr.getLeagueDynamicsById(league_id)["dynamics"];
          var new_page = null;
          ...
          if (this.dynamic_page_map.size > 0) {
            var first_page = this.dynamic_page_map.get(1);
        ...
        createDynamic(parent, info) {
          ...
          var new_dynamic = this.gen.generator(parent, "League_Dynamic");

          if (!new_dynamic) {
            return;
          }

          var content = (_new_dynamic$getChild = new_dynamic.getChildByPath("Mask/Content")) === null || _new_dynamic$getChild === void 0 ? void 0 : _new_dynamic$getChild.getComponent(Label);
          var time = (_new_dynamic$getChild2 = new_dynamic.getChildByName("Timestamp")) === null || _new_dynamic$getChild2 === void 0 ? void 0 : _new_dynamic$getChild2.getComponent(Label);
        ...
        turnToPage(page_num, isNext) {
          ...
          var page = this.dynamic_page_map.get(page_num);
